...
for letter in alphabet:
    ...
    base_q = sa.force_matching_name().language("en").place_name_language("en").country('US').max_rows(num_rows).feature_class("L").feature_code("RGNE").verbosity("FULL").order_by("relevance")
